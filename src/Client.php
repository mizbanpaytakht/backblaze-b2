...
use mizbanpaytakht\B2\Exceptions\CacheException;
use mizbanpaytakht\B2\Exceptions\NotFoundException;
use mizbanpaytakht\B2\Exceptions\ValidationException;
use mizbanpaytakht\B2\Http\Client as HttpClient;
...
class Client
{
     ...
     * @throws \Exception
     */
    public function createKey(array $key) : Key
    {
        $response = $this->request('POST', '/b2_create_key', [
            'json' => [
                'capabilities' => implode(',',$key['capabilities']),
                'keyName' => $key['keyName'],
